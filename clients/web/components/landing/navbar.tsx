    ...
    groups: [
      {
        ...
        items: [
          ...
          { name: "Open Source", desc: "Contribute on GitHub", href: "https://github.com/Dragoon4002/artic-trader", icon: <GitBranch className="w-4 h-4" />, colors: ["#4A2A1A", "#7A4A30"] },
        ],
      },
    ],
  },
        ...
        >
          ...
          <Link
            ...
            className={cn(
              ...
              "ml-4 px-5 py-4 text-sm font-semibold rounded-full bg-orange hover:bg-orange-hover text-white transition-opacity hover:opacity-90"
            )}
          >
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-surface/95 backdrop-blur-xl border-t border-white/[0.06] overflow-hidden"
          >
            <div className="p-6 space-y-2">
              ...
              <Link
                ...
                className={cn(
                  buttonVariants(),
                  "block w-full text-center px-5 py-2.5 text-sm font-semibold rounded-full bg-orange hover:bg-orange-hover text-white mt-4"
                )}
              >
                Launch App →
              </Link>
