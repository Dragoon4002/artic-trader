...
export function ClientCard({ tag, tagColor, title, description }: ClientCardProps) {
  return (
    <div className="p-7 rounded-[14px] border border-white/8 bg-white/3 transition-all duration-200 hover:border-orange-light/40 hover:bg-orange/6 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-orange/5">
      <Badge
        className={cn(
