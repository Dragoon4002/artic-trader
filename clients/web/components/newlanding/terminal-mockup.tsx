...
const lines: Line[] = [
  { prefix: "$ ", text: "uvicorn hub.server:app --port 8000", color: "text-gray", delay: 0 },
  { text: "✓ Hub online — 4 agents registered", color: "text-teal", delay: 0.6 },
  { prefix: "", text: "", delay: 0.9 },
  { prefix: "$ ", text: "curl -X POST /api/agents -d '{\"symbol\": \"BTC/USDT\", \"strategy\": \"momentum\"}'", color: "text-gray", delay: 1.2 },
  { text: "→ Agent btc-001 created (port 8101)", color: "text-white/60", delay: 1.8 },
  { prefix: "", text: "", delay: 2.0 },
  { prefix: "$ ", text: "curl -X POST /api/agents/btc-001/start", color: "text-gray", delay: 2.3 },
  ...
  { prefix: "$ ", text: "curl /api/agents/btc-001/status", color: "text-gray", delay: 4.4 },
